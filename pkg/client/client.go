...
import (
	...
	"github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/admin"
	"github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/auth"
	"github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/management"
	oidcV2_pb "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/oidc/v2"
	oidcV2Beta_pb "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/oidc/v2beta"
	orgV2 "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/org/v2"
	orgV2Beta "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/org/v2beta"
	sessionV2 "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/session/v2"
	sessionV2Beta "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/session/v2beta"
	settingsV2 "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/settings/v2"
	settingsV2Beta "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/settings/v2beta"
	"github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/system"
	userV2 "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/user/v2"
	userV2Beta "github.com/nobletrout/zitadel-go/v3/pkg/client/zitadel/user/v2beta"
